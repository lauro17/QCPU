...
public class JDialogMensagem extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        imagem1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagem96/SUCESSO.png"))); // NOI18N
    ...
    public void showMessage(String title, String message, String icone, String tipo, String tipoAlerta) {
        if (tipoAlerta != null) {
            setTIPO_ALERTA(tipoAlerta);
        }
        ...
        switch (icone) {
            case "PADRAO":
                imagem1.setIcon(new ImageIcon(getClass().getResource("/Imagem96/INFORMACAO.png")));
                break;
            case "INFORMACAO":
                imagem1.setIcon(new ImageIcon(getClass().getResource("/Imagem96/INFORMACAO.png")));
                break;
            case "AVISO":
                imagem1.setIcon(new ImageIcon(getClass().getResource("/Imagem96/AVISO.png")));
                break;
            case "ERRO":
                imagem1.setIcon(new ImageIcon(getClass().getResource("/Imagem96/ERRO.png")));
                break;
            case "SUCESSO":
                imagem1.setIcon(new ImageIcon(getClass().getResource("/Imagem96/SUCESSO.png")));
                break;
            case "AJUDA":
                imagem1.setIcon(new ImageIcon(getClass().getResource("/Imagem96/AJUDA.png")));
                break;
            case "GORJETA":
                imagem1.setIcon(new ImageIcon(getClass().getResource("/Imagem96/GORJETA.png")));
                break;
            case "PEDIDO_DE_ENTRADA":
                imagem1.setIcon(new ImageIcon(getClass().getResource("/Imagem96/PEDIDO_DE_ENTRADA.png")));
                break;
            case "FALHA":
                imagem1.setIcon(new ImageIcon(getClass().getResource("/Imagem96/FALHA.png")));
                break;
    ...
    /**
     * @param TIPO_ALERTA the TIPO_ALERTA to set
     */
