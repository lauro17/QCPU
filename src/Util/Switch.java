...
public class Switch extends JComponent implements MouseListener {
     ...
     */
    private final Color DISABLED_COMPONENT_COLOR = new Color(255, 0, 51);
    ...
    public Switch() {
        super();
        Switch.this.setSize(new Dimension(20, 10));
        Switch.this.setPreferredSize(new Dimension(20, 10));
        Switch.this.setMinimumSize(new Dimension(20, 10));
